...
public class PaymentEmployerActivity extends Activity {
    ...
    private class SignUpFormSubmission extends AsyncTask<String, Void, String> implements com.example.new_go_delivery_app.SignUpFormSubmission {
        @Override
        protected String doInBackground(String... urls) {
        ...
        // onPostExecute displays the results of the AsyncTask.
        @Override
        public <PaymentJobEmployerActivity> void onPostExecute(String result) {
            ...
            if (result.equals("OK")) {
                ...
                Intent intent = new Intent(String.valueOf(DeciderActivity.class));
    ...
    public <PaymentJobEmployerActivity> void LogOutClicked(View v)
    {
        LogoutUser();

        Intent intent = new Intent(String.valueOf(AlreadyLoggedInActivity.class));
