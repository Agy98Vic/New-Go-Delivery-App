...
public class PreJobPhotoEmployerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView jobStatusTitle = (TextView) findViewById(R.id.PreJobEmployerStatusTitleID);
        ...
        for (int i = 0; i < jobDetails.length; ++i) {
            jobDetails[i] = Double.parseDouble("");
    ...
    public void jobDetailsPrePhotoEmployerButton(View v) {
        ...
        View dialoglayout = ((LayoutInflater) inflater).inflate(R.layout.view_job_details, null);



        jobTitleTextView = (TextView) dialoglayout.findViewById(R.id.GeneralJobTitleID);
        distanceTextView = (TextView) dialoglayout.findViewById(R.id.GeneralDistanceID);
        rateTextView = (TextView) dialoglayout.findViewById(R.id.GeneralRateID);
